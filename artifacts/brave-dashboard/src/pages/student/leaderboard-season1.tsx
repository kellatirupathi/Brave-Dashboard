// Leaderboard — SEASON 1 (frozen).
//
// The page exactly as it stood before the Season 2 redesign, preserved rather
// than migrated. Season 1 is a closed cohort: its rankings are settled and its
// screens are read back for reference, so restyling it would change how past
// results LOOK without changing what they ARE.
//
// TREAT AS FROZEN. Changes belong in leaderboard-season2.tsx unless a genuine
// bug is being fixed here.
...
export default function LeaderboardSeason1({
  headerExtra,
