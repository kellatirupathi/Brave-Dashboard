...
function AdminDashboardLegacy() {
  ...
  const metrics: {
    ...
    },
    {
      ...
      value: formatINR(summary.totalPendingRevenue),
      sub: "Awaiting review",
      icon: Clock,
      href: "/admin/queue",
      testid: "metric-pending-revenue",
      valueClass: "text-amber-600 dark:text-amber-500",
    },
    {
      label: "Rejected revenue",
      value: formatINR(summary.totalRejectedRevenue),
      sub: "Rejected entries",
      icon: X,
      href: "/admin/queue",
      testid: "metric-rejected-revenue",
