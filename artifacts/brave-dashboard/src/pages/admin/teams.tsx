    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">Manage all {teams?.length || 0} teams across campuses</p>
        </div>
            ...
            <TableBody>
              {teams?.map((team) => (
                <TableRow key={team.id} className="hover:bg-muted/50 cursor-pointer transition-colors">
                  ...
                  <TableCell className="text-right font-medium">{formatINR(team.totalRevenue)}</TableCell>
